...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(435.7816,69.8556,0.5523,0.5523);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAJAbIgTgYIAAAYIgOAAIAAg0IAOAAIAAAZIASgZIAQAAIAAABIgUAZIAVAYIAAACg");
	this.shape_1.setTransform(432.2469,69.8556,0.5523,0.5523);
	...
	this.shape_2.setTransform(427.2901,69.2618,0.5523,0.5523);
	...
	this.shape_3.setTransform(423.7278,69.2618,0.5523,0.5523);
	...
	this.shape_4.setTransform(420.1655,69.2618,0.5523,0.5523);
	...
	this.shape_5.setTransform(415.1949,69.2618,0.5523,0.5523);
	...
	this.shape_18.setTransform(414.974,45.4719,0.5523,0.5523);
	...
	this.shape_19.setTransform(411.5912,46.0242,0.5523,0.5523);
	...
	this.shape_20.setTransform(408.1255,45.4719,0.5523,0.5523);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgYAlIAAhJIAxAAIAAAMIgiAAIAAA9g");
	this.shape_21.setTransform(405.5436,44.8644,0.5523,0.5523);
	...
	this.shape_22.setTransform(401.4995,52.8733,0.5523,0.5523);
...
p.nominalBounds = new cjs.Rectangle(348.1,27.6,106.89999999999998,50.6);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(314.75,-47.525);
	...
	this.shape_3.setTransform(300.05,-44.925);
	...
	this.shape_4.setTransform(282.875,-47.55);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAcBFIAAhrIg3AAIAABrIglAAIAAiJICBAAIAACJg");
	this.shape_5.setTransform(266.175,-47.525);
	...
	this.shape_8.setTransform(219.55,-47.55);
	...
	this.shape_9.setTransform(203.55,-44.925);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgSBFIAAhrIgpAAIAAgeIB3AAIAAAeIgqAAIAABrg");
	this.shape_10.setTransform(188.15,-47.525);
	...
	this.shape_11.setTransform(373.45,-83.125);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AAdBFIAAhWIgBAAIgzBWIgqAAIAAiJIAlAAIAABVIABAAIAyhVIArAAIAACJg");
	this.shape_12.setTransform(356.5,-79.875);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AAXBFIgxg9IgBAAIAAA9IgmAAIAAiJIAmAAIAABCIABAAIAwhCIApAAIAAACIg2BDIA5BCIAAACg");
	this.shape_13.setTransform(341.125,-79.875);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgYBAQgQgJgIgQQgJgRAAgWQAAgVAJgRQAIgQAQgJQAQgJAXAAQANAAALADQALADAIADIgIAdIgOgEQgHgCgKAAQgKAAgJAEQgIAEgEAJQgGAJAAAOQAAAPAGAJQAEAKAIAEQAIADALAAQAKAAAHgCIAOgDIAIAdIgTAGQgLACgNAAQgXAAgQgJg");
	this.shape_14.setTransform(325.85,-79.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgjA/QgPgJgIgRQgHgQAAgVQAAgTAHgQQAIgRAPgJQAPgLAWAAQAXAAAOAJQAOAHAHAOQAHANAAAQIgBAOIgCAKIhbAAQACAPAIAIQAJAIAPAAQAMAAALgCIAVgGIAJAcQgKAFgPADQgOADgRAAQgWAAgRgKgAgNgnQgGAEgDAIQgEAHgBAIIA6AAIABgCIAAgCQgBgMgGgHQgHgJgPAAQgJAAgHAFg");
	this.shape_15.setTransform(311.2,-79.9);
	...
	this.shape_16.setTransform(295.6,-79.875);
	...
	this.shape_17.setTransform(280.35,-77.275);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AgiA/QgQgJgIgRQgIgQAAgVQAAgTAIgQQAIgRAQgJQAPgLAVAAQAXAAAOAJQAOAHAHAOQAGANAAAQIAAAOIgBAKIhbAAQAAAPAKAIQAIAIAPAAQAMAAALgCIAVgGIAJAcQgLAFgOADQgOADgRAAQgXAAgPgKgAgNgnQgHAEgDAIQgDAHAAAIIA5AAIAAgCIAAgCQAAgMgGgHQgGgJgRAAQgIAAgHAFg");
	this.shape_18.setTransform(263.9,-79.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AAqBFIAAhOIAAAAIgbAtIgdAAIgbgtIAAAAIAABOIgmAAIAAiJIAlAAIAqBHIAAAAIArhHIAlAAIAACJg");
	this.shape_19.setTransform(246.275,-79.875);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AAqBFIAAhOIAAAAIgbAtIgdAAIgbgtIAAAAIAABOIgmAAIAAiJIAlAAIAqBHIAAAAIArhHIAlAAIAACJg");
	this.shape_20.setTransform(226.625,-79.875);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgnA/QgQgJgIgRQgJgQAAgVQAAgTAJgQQAIgRAQgKQAQgJAXgBQAYABAQAJQAQAKAIARQAJAQAAATQAAAVgJAQQgIARgQAJQgQAKgYAAQgXAAgQgKgAgXgeQgJALAAATQAAAVAJAKQAJAKAOAAQAPAAAJgKQAJgKAAgVQAAgTgJgLQgJgKgPAAQgOAAgJAKg");
	this.shape_21.setTransform(208.375,-79.9);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AAhBhIhHhXIgBAAIAABXIgnAAIAAjBIAnAAIAABeIABAAIBFheIAsAAIAAADIhJBfIBNBcIAAADg");
	this.shape_22.setTransform(191.8,-82.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ClipGroup_3, new cjs.Rectangle(179.1,-104,205.6,72.1), null);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_5, new cjs.Rectangle(-2,-7.9,479.5,50.3), null);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroupcopy2, new cjs.Rectangle(-13.5,-3.8,199.7,40.199999999999996), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(729.95,-88.3,1.2563,1.2563,0,0,0,104,14.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgQAeIAAgGIATgWIAEgFQACgDAAgFIgBgGQgBgDgCgBQgDgCgDAAQgDAAgEACIgFAEIgEgFIAFgEIAFgCIAHgBQAEAAAEACQAFACACAEQACAFAAAFIgBAHIgDAFIgFAFIgOASIAXAAIAAAGg");
	this.shape.setTransform(620,-91.775);

	this.instance_1 = new lib.ClipGroup_1_1();
	this.instance_1.setTransform(727.2,-89.8,1.2563,1.2563,0,0,0,101.8,13.3);
...
p.nominalBounds = new cjs.Rectangle(530.7,-111.2,326.5,50.400000000000006);
...
p.nominalBounds = new cjs.Rectangle(-4,-24.2,481.5,114.9);
...
p.nominalBounds = new cjs.Rectangle(179.4,27.6,597.9,52.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(170.4,62.3,0.1676,0.1676,41.2674,0,0,-31.9,171.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-31.8,regY:169.9,scaleX:0.0709,scaleY:0.0709,rotation:26.2616,x:245.9,y:-1.55,startPosition:99},119).to({_off:true},1).wait(189));

	// cta_copy
	this.instance_1 = new lib.Symbol7("synched",0);
	this.instance_1.setTransform(235.65,24.8,0.5449,0.5459,0,0,0,79.7,21.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(249).to({_off:false},0).wait(60));

	// info
	this.instance_2 = new lib.ClipGroup_6("synched",0);
	this.instance_2.setTransform(160.6,25.05,0.463,0.463,0,0,0,470.2,52.9);
	...
	this.instance_3.setTransform(94.25,24.95,0.3506,0.3506,0,0,0,163.5,46.6);
	...
	this.instance_4.setTransform(-75.2,25,0.3342,0.3342,0,0,0,212,124.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(179).to({startPosition:0},0).to({scaleX:1.1199,x:91.35},15,cjs.Ease.quadOut).wait(115));

	// TX
	this.instance_5 = new lib.Symbol3("synched",0);
	this.instance_5.setTransform(65.2,17.1,0.3092,0.3092,0,0,0,170,17.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},210).wait(99));

	// logo
	this.instance_6 = new lib.Symbol2("synched",0);
	this.instance_6.setTransform(295.2,23.25,0.4967,0.4967,0,0,0,31.9,90.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},210).wait(99));

	// blue
	this.instance_7 = new lib.Symbol1("synched",0);
	this.instance_7.setTransform(82.75,25,0.3899,0.3342,0,0,0,212.2,124.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},210).wait(99));

	// bg
	this.instance_8 = new lib.Symbol6("synched",0);
	this.instance_8.setTransform(210.6,12.4,0.277,0.277,0,0,0,450.3,387.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:450.6,scaleX:0.2288,scaleY:0.2288,x:229.7,y:12.85},194).to({_off:true},16).wait(99));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(13.8,-69.8,315.2,169.6);
// library properties:
lib.properties = {
