...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(76.6137,38.7044,0.5053,0.5053);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAJAbIgTgYIAAAYIgOAAIAAg0IAOAAIAAAZIASgZIAQAAIAAABIgUAZIAVAYIAAACg");
	this.shape_1.setTransform(73.3799,38.7044,0.5053,0.5053);
	...
	this.shape_2.setTransform(68.845,38.1612,0.5053,0.5053);
	...
	this.shape_3.setTransform(65.5859,38.1612,0.5053,0.5053);
	...
	this.shape_4.setTransform(62.3269,38.1612,0.5053,0.5053);
	...
	this.shape_5.setTransform(57.7794,38.1612,0.5053,0.5053);
	...
	this.shape_18.setTransform(57.5772,16.3963,0.5053,0.5053);
	...
	this.shape_19.setTransform(54.4824,16.9016,0.5053,0.5053);
	...
	this.shape_20.setTransform(51.3118,16.3963,0.5053,0.5053);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgYAlIAAhJIAxAAIAAAMIgiAAIAAA9g");
	this.shape_21.setTransform(48.9496,15.8405,0.5053,0.5053);
	...
	this.shape_22.setTransform(45.2499,23.1678,0.5053,0.5053);
...
p.nominalBounds = new cjs.Rectangle(-3.6,0,97.8,46.4);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(75.3255,15.425);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_1, new cjs.Rectangle(-46,0,62.4,14.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(153.725,31.15);
	...
	this.shape_1.setTransform(148.45,28.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAKAdIgVgaIAAAaIgKAAIAAg5IAKAAIAAAcIAVgcIALAAIAAABIgWAcIAXAbIAAABg");
	this.shape_2.setTransform(142.125,28.8);
	...
	this.shape_3.setTransform(132.7,27.625);
	...
	this.shape_4.setTransform(126.1,27.625);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgVApIAAgJIASAAIAAg9IAAAAIgPAFIgCAAIAAgJIATgHIAHAAIAABIIAQAAIAAAJg");
	this.shape_5.setTransform(119.6,27.625);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgSApIAAgBIAchQIAJAAIAAABIgbBQg");
	this.shape_6.setTransform(113.925,27.625);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AALAdIAAgSIgGACIgHAAQgJAAgFgEQgEgEAAgHIAAgaIAKAAIAAAZQAAADACADQACACAGAAIAGAAIAFgCIAAgfIAKAAIAAA5g");
	this.shape_7.setTransform(108.6,28.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgDATIABgMIgBAAIgKAHIgFgHIAMgHIAAAAIgMgFIAEgHIALAHIAAgNIAHAAIgBANIABAAIALgHIAEAHIgMAFIAMAGIgEAIIgLgIIgBABIABAMg");
	this.shape_8.setTransform(103.225,25.25);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgEAdIAAgxIgQAAIAAgIIApAAIAAAIIgQAAIAAAxg");
	this.shape_9.setTransform(98.15,28.8);
	...
	this.shape_10.setTransform(92.35,27.625);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAKAdIgVgaIAAAaIgKAAIAAg5IAKAAIAAAcIAVgcIALAAIAAABIgWAcIAXAbIAAABg");
	this.shape_11.setTransform(86.025,28.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgJA0QAFgMADgNQABgNAAgOQAAgNgBgNQgDgOgFgLIAHgEQAFALAEAOQADAOAAAQQAAARgDAPQgEANgFALg");
	this.shape_12.setTransform(78.15,28.7);
	...
	this.shape_16.setTransform(52.1,27.625);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AgFAgQgFgPAAgRQAAgQAFgOQAEgOAEgLIAIAEQgGALgCAOQgDANAAANQAAAOADANQACANAGAMIgIAEQgEgLgEgNg");
	this.shape_17.setTransform(45,28.7);
	...
	this.shape_18.setTransform(36.875,27.625);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgHAQIAAgCIAFgdIAKAAIAAACIgIAdg");
	this.shape_19.setTransform(32.1,32.075);
	...
	this.shape_20.setTransform(27.5,27.625);
	...
	this.shape_21.setTransform(20.825,27.525);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AgWAEIAAgIIAtAAIAAAIg");
	this.shape_22.setTransform(14.375,28.45);
	...
	this.shape_23.setTransform(7.8,27.725);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AgHAQIAAgCIAFgdIAKAAIAAACIgIAdg");
	this.shape_24.setTransform(2.95,32.075);
	...
	this.shape_25.setTransform(-1.725,27.525);
	...
	this.shape_26.setTransform(-8.325,27.525);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup, new cjs.Rectangle(-13.5,-3.8,199.7,40.199999999999996), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AldFeIAAq7IK7AAIAAK7g");
	mask.setTransform(35,35);

	// Layer_3
	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#FFFFFF").s().p("");
	this.shape_54.setTransform(34.95,35);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup_2, new cjs.Rectangle(11,11,48,48), null);
...
if (reversed == null) { reversed = false; }
	...
	mask_1._off = true;
	mask_1.graphics.p("Aw/EdIAAo5MAh/AAAIAAI5g");
	mask_1.setTransform(97.3743,28.4749);

	// Layer_3
	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#FFFFFF").s().p("AgOA3IAAhWIghAAIAAgYIBfAAIAAAYIghAAIAABWg");
	this.shape_55.setTransform(147.825,37.95);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("#FFFFFF").s().p("Ag3BQIAAicIAXAAIAFAKIAJgGIAMgFQAGgCAHAAQARAAAKAIQALAIAFAOQAGAMAAARQAAAQgGAMQgFAOgLAIQgKAIgRAAQgKgBgIgDIgMgIIgBAAIAAA2gAgNgzIgLAEIAAA0QAFAEAGACIAMACQAMgBAHgJQAGgIAAgPQAAgPgGgJQgHgJgMgBQgGABgGACg");
	this.shape_56.setTransform(135.975,40.05);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("#FFFFFF").s().p("AgfAzQgNgIgHgOQgHgNAAgQQAAgQAHgMQAHgOANgIQANgIASAAQATAAANAIQANAIAHAOQAHAMAAAQQAAAQgHANQgHAOgNAIQgNAIgTAAQgSAAgNgIgAgTgYQgHAIAAAQQAAARAHAIQAIAJALAAQAMAAAHgJQAIgIAAgRQAAgQgIgIQgHgJgMAAQgLAAgIAJg");
	this.shape_57.setTransform(122.125,37.95);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("#FFFFFF").s().p("AAXA3IAAhWIgsAAIAABWIgfAAIAAhuIBoAAIAABug");
	this.shape_58.setTransform(108.6,37.95);

	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#FFFFFF").s().p("AgTA0QgNgIgHgNQgHgNAAgSQAAgRAHgNQAHgNANgIQANgHASAAQAKAAAKADIAPADIgHAYIgLgCQgGgCgHgBQgJAAgHAEQgGADgEAHQgEAIAAALQAAAMAEAHQAEAIAGADQAHADAJABIANgCIALgEIAHAYIgPAEQgKADgKAAQgSAAgNgHg");
	this.shape_59.setTransform(96.325,37.95);

	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f("#FFFFFF").s().p("AAXA3IAAgrIgsAAIAAArIgfAAIAAhuIAfAAIAAAsIAsAAIAAgsIAdAAIAABug");
	this.shape_60.setTransform(83.95,37.95);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f("#FFFFFF").s().p("");
	this.shape_61.setTransform(71.0491,37.95);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#FFFFFF").s().p("Ag3BQIAAicIAXAAIAFAKIAJgGIAMgFQAGgCAHAAQARAAAKAIQALAIAFAOQAGAMAAARQAAAQgGAMQgFAOgLAIQgKAIgRAAQgKgBgIgDIgMgIIgBAAIAAA2gAgNgzIgLAEIAAA0QAFAEAGACIAMACQAMgBAHgJQAGgIAAgPQAAgPgGgJQgHgJgMgBQgGABgGACg");
	this.shape_62.setTransform(58.125,40.05);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#FFFFFF").s().p("AgOA3IAAhWIghAAIAAgYIBfAAIAAAYIghAAIAABWg");
	this.shape_63.setTransform(45.675,37.95);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#FFFFFF").s().p("AAXBSIAAhGIgBAAIgoBGIgiAAIAAhvIAeAAIAABFIABAAIAohFIAiAAIAABvgAgXg0QgJgFgGgJIAKgPQAGAFAHABQAIACAIAAQAJAAAIgCQAHgBAGgFIAKAPQgGAJgKAFQgKAEgOAAQgOAAgKgEg");
	this.shape_64.setTransform(170.775,11.25);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#FFFFFF").s().p("AAXA4IAAhFIgBAAIgoBFIgiAAIAAhvIAeAAIAABFIABAAIAohFIAiAAIAABvg");
	this.shape_65.setTransform(157.125,13.85);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("#FFFFFF").s().p("AASA4IgngxIAAAAIAAAxIgfAAIAAhvIAfAAIAAA1IAAAAIAmg1IAiAAIAAACIgsA1IAuA2IAAACg");
	this.shape_66.setTransform(144.7,13.85);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("#FFFFFF").s().p("AgTAzQgNgGgHgOQgHgNAAgSQAAgRAHgNQAHgOANgGQANgIASAAQAKAAAKACIAPAFIgHAXIgLgCQgGgCgHAAQgJgBgHAEQgGADgEAHQgEAIAAALQAAAMAEAIQAEAGAGAEQAHADAJAAIANgBIALgDIAHAXIgPAFQgKACgKAAQgSAAgNgIg");
	this.shape_67.setTransform(132.375,13.85);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#FFFFFF").s().p("AgcAzQgMgIgHgNQgGgOAAgQQAAgQAGgNQAHgNAMgHQAMgJASAAQASAAALAHQALAGAGALQAGALgBANIAAAKIgBAJIhJAAQABAMAHAGQAHAHALAAQAKAAAJgCIARgFIAHAXQgIADgMADQgLADgOAAQgSgBgNgHgAgKgfQgGADgCAGQgDAGAAAGIAuAAIAAgBIAAgCQAAgJgFgHQgFgGgNgBQgHABgFAEg");
	this.shape_68.setTransform(120.5519,13.85);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f("#FFFFFF").s().p("AARA4IAAgjIgMADIgQABQgLABgJgFQgIgFgEgHQgEgIAAgHIAAgxIAeAAIAAAuQAAAFAEADQAEACAHAAIAMgBQAFAAACgCIAAg1IAfAAIAABvg");
	this.shape_69.setTransform(108,13.85);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f("#FFFFFF").s().p("Ag3BQIAAicIAXAAIAFAKIAJgFIAMgGQAGgCAHAAQARABAKAHQALAIAFANQAGAOAAAQQAAAQgGANQgFANgLAIQgKAHgRABQgKgBgIgDIgMgHIgBAAIAAA1gAgNgzIgLAEIAAA0QAFAEAGACIAMABQAMAAAHgJQAGgIAAgPQAAgPgGgJQgHgJgMAAQgGAAgGACg");
	this.shape_70.setTransform(95.675,15.95);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f("#FFFFFF").s().p("AgcAzQgMgIgHgNQgGgOAAgQQAAgQAGgNQAHgNAMgHQAMgJASAAQASAAALAHQALAGAGALQAGALgBANIAAAKIgBAJIhJAAQABAMAHAGQAHAHALAAQAKAAAJgCIARgFIAHAXQgIADgMADQgLADgOAAQgSgBgNgHgAgKgfQgGADgCAGQgDAGAAAGIAuAAIAAgBIAAgCQAAgJgFgHQgFgGgNgBQgHABgFAEg");
	this.shape_71.setTransform(82.4019,13.85);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f("#FFFFFF").s().p("AAiA4IAAg/IAAAAIgWAkIgXAAIgWgkIAAAAIAAA/IgeAAIAAhvIAdAAIAiA6IAAAAIAjg6IAdAAIAABvg");
	this.shape_72.setTransform(68.175,13.85);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f("#FFFFFF").s().p("AAiA4IAAg/IAAAAIgWAkIgXAAIgWgkIAAAAIAAA/IgeAAIAAhvIAdAAIAiA6IAAAAIAjg6IAdAAIAABvg");
	this.shape_73.setTransform(52.325,13.85);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f("#FFFFFF").s().p("AgfAzQgNgIgHgNQgHgOAAgQQAAgPAHgOQAHgNANgIQANgHASgBQATABANAHQANAIAHANQAHAOAAAPQAAAQgHAOQgHANgNAIQgNAHgTABQgSgBgNgHgAgTgYQgHAIAAAQQAAAQAHAJQAIAIALAAQAMAAAHgIQAIgJAAgQQAAgQgIgIQgHgJgMABQgLgBgIAJg");
	this.shape_74.setTransform(37.625,13.85);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f("#FFFFFF").s().p("AAbBPIg5hGIgBAAIAABGIggAAIAAidIAgAAIAABNIABAAIA4hNIAjAAIAAADIg8BMIA/BLIAAADg");
	this.shape_75.setTransform(24.225,11.55);
...
if (reversed == null) { reversed = false; }
	...
	mask_2._off = true;
	mask_2.graphics.p("AnSHTIAAulIOlAAIAAOlg");
	mask_2.setTransform(46.7,46.7);

	// Layer_3
	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f("#FFFFFF").s().p("");
	this.shape_76.setTransform(46.7,46.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_77.graphics.f("#FFFFFF").s().p("AA2BcIAAiYIgBAAIhpCYIgSAAIAAi2IASAAIAACYIAAAAIBpiYIATAAIAAC2g");
	this.shape_77.setTransform(196.5,22.8);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f("#FFFFFF").s().p("AA1B+IAAiXIAAAAIhpCXIgTAAIAAi2IASAAIAACYIABAAIBpiYIASAAIAAC2gAgbhiQgLgIgHgMIAKgHQAGAIAIAFQAHAGAQAAQARAAAHgGQAIgFAGgIIAKAHQgHAMgKAIQgMAIgTAAQgSAAgLgIg");
	this.shape_78.setTransform(165.75,19.35);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f("#FFFFFF").s().p("ABFBcIAAi2IASAAIAAC2gAhWBcIAAi2IASAAIAABLIAxAAQAdAAAQAOQAQANABAaQgBAagQANQgQAOgdABgAhEBLIAvAAQANABAKgEQAKgEAHgHQAGgJAAgOQAAgOgGgIQgHgJgKgDQgKgDgNAAIgvAAg");
	this.shape_79.setTransform(143.475,22.8);

	this.shape_80 = new cjs.Shape();
	this.shape_80.graphics.f("#FFFFFF").s().p("AA2BcIAAhXIhrAAIAABXIgTAAIAAi2IATAAIAABRIBrAAIAAhRIASAAIAAC2g");
	this.shape_80.setTransform(121.1,22.8);

	this.shape_81 = new cjs.Shape();
	this.shape_81.graphics.f("#FFFFFF").s().p("ABiBcIhYhWIgBAAIAABWIgRAAIAAhWIgBAAIhYBWIgYAAIAAgCIBehaIhbhZIAAgBIAXAAIBWBXIABAAIAAhXIARAAIAABXIABAAIBWhXIAXAAIAAABIhbBZIBeBaIAAACg");
	this.shape_81.setTransform(97.625,22.8);

	this.shape_82 = new cjs.Shape();
	this.shape_82.graphics.f("#FFFFFF").s().p("AgpBUQgUgNgJgWQgJgWAAgbQABgbAKgXQAKgVASgNQATgMAYAAQAaAAARAKQARALAIARQAJARAAAUIgBANIgCALIiJAAQABAXAHARQAHARAQAKQAPAKAWAAQASAAANgGQANgEALgIIAIAOQgMAJgOAGQgQAGgVAAQgeAAgTgNgAgng9QgRARgEAgIB4AAIABgFIAAgFQgBgQgGgOQgGgNgMgGQgNgIgUAAQgaAAgQASg");
	this.shape_82.setTransform(74.65,22.8);

	this.shape_83 = new cjs.Shape();
	this.shape_83.graphics.f("#FFFFFF").s().p("ABCByIgCgtIiAAAIgCAtIgPAAIgDg+IAMAAQAJgIAGgKQAHgLAEgQQAEgPACgZIAFhQIBnAAIAAClIARAAIgDA+gAgXggQgCAagEAPQgEAQgFAKQgGAKgHAHIBlAAIAAiVIhEAAg");
	this.shape_83.setTransform(54.175,25.075);

	this.shape_84 = new cjs.Shape();
	this.shape_84.graphics.f("#FFFFFF").s().p("");
	this.shape_84.setTransform(35.95,22.7993);

	this.shape_85 = new cjs.Shape();
	this.shape_85.graphics.f("#FFFFFF").s().p("ABKCBIAAh8IiTAAIAAB8IgTAAIAAkBIATAAIAAB0ICTAAIAAh0IATAAIAAEBg");
	this.shape_85.setTransform(13.05,19.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_85},{t:this.shape_84},{t:this.shape_83},{t:this.shape_82},{t:this.shape_81},{t:this.shape_80},{t:this.shape_79},{t:this.shape_78},{t:this.shape_77}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(124.95,1.75,0.7603,0.7603,0,0,0,103.9,14.6);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJASIAAgDIALgOIACgDQABAAAAgBQAAAAAAgBQABAAAAgBQAAgBAAAAIgBgEIgCgCIgDgBIgEABIgDACIgDgDIADgCIADgCIAEAAIAFABIAEAEQABACAAAEIAAAEIgCACIgDAEIgJAKIAPAAIAAAEg");
	this.shape.setTransform(58.475,-0.475);

	this.instance_1 = new lib.ClipGroup_1();
	this.instance_1.setTransform(123.2,0.9,0.7603,0.7603,0,0,0,101.6,13.5);
...
p.nominalBounds = new cjs.Rectangle(4.5,-12.2,197.5,30.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(260.65,432.3,0.6526,0.6526,0,0,0,449.9,387.6);
...
p.nominalBounds = new cjs.Rectangle(-32.9,179.4,587.3,505.70000000000005);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-286.55,63.25,1,1,0,0,0,35,35);
...
p.nominalBounds = new cjs.Rectangle(-321.5,28.3,70,70);
...
p.nominalBounds = new cjs.Rectangle(-44.9,0,176.5,159.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(151.15,105.45,0.894,0.894,0,0,0,46.8,46.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(249).to({_off:false},0).wait(60));

	// info
	this.instance_1 = new lib.ClipGroupcopy("synched",0);
	this.instance_1.setTransform(150.05,70.4,1.0823,1.0823,0,0,0,46,23.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(189).to({_off:false},0).to({_off:true},60).wait(60));

	// BLUE
	this.instance_2 = new lib.Symbol15("synched",0);
	this.instance_2.setTransform(-559.9,125,1,1,0,0,0,212.1,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(179).to({startPosition:0},0).to({x:-245.25},15,cjs.Ease.quadOut).wait(115));

	// cta
	this.instance_3 = new lib.Symbol7("synched",0);
	this.instance_3.setTransform(74.9,133.2,0.6815,0.6818,0,0,0,80.1,22.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(89).to({_off:false},0).to({_off:true},106).wait(114));

	// TX
	this.instance_4 = new lib.Symbol3("synched",0);
	this.instance_4.setTransform(145.7,31.3,0.7332,0.7332,0,0,0,169.8,17.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},210).wait(99));

	// bite
	this.instance_5 = new lib.Symbol10("synched",0);
	this.instance_5.setTransform(-22.2,278.2,0.5024,0.5024,40.7876,0,0,-31.7,171.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:-31.6,regY:170.3,scaleX:0.212,scaleY:0.212,rotation:56.263,x:209.55,y:-22.6,startPosition:99},119).to({_off:true},1).wait(189));

	// logo
	this.instance_6 = new lib.Symbol2("synched",0);
	this.instance_6.setTransform(570,120.85,1,1,0,0,0,31.8,138.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},210).wait(99));

	// bg
	this.instance_7 = new lib.Symbol6("synched",0);
	this.instance_7.setTransform(301.85,87.4,0.8289,0.8289,0,0,0,450.1,387.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regX:450.6,regY:387,scaleX:0.6521,scaleY:0.6521,x:304.3,y:119.4},194).to({_off:true},16).wait(99));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-279.1,-84.7,667.4000000000001,544.6);
// library properties:
lib.properties = {
